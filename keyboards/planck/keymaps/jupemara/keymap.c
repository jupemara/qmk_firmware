...
[_Q] = LAYOUT_planck_grid(
    ...
    KC_MPLY, KC_LEFT, KC_DOWN, KC_LGUI, RAISE,   KC_SPC,  KC_BSPC,  LOWER,  KC_TAB,  KC_UP,   KC_RGHT, KC_RGUI
),
...
[_A] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX,  _______, XXXXXXX, KC_MPLY, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_TOG
)
