...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //        `-------+-------+-------+-------+-------+-------+-------.    ,-------+-------+-------+-------+-------+-------+-------'
                                     KC_LGUI,KC_LSFT,LOWER  ,KC_SPC ,     KC_BSPC,RAISE  ,KC_ENT ,KC_TAB
  //                                `-------+-------+-------+-------'    `-------+-------+-------+-------'
  ),
  ...
  //|-------+-------+-------+-------+-------+-------|                                    |-------+-------+-------+-------+-------+-------|
     _______,KC_EXLM,KC_AT,  KC_HASH,KC_DLR, KC_PERC,                                     KC_LEFT,KC_DOWN,KC_UP, KC_RIGHT,KC_QUOT,KC_ENT,
  //`-------+-------+-------+-------+-------+-------|                                    |-------+-------+-------+-------+-------+-------|
  ...
  //|-------+-------+-------+-------+-------+-------|                                    |-------+-------+-------+-------+-------+-------|
     _______,KC_QUOT,KC_DQUO,KC_GRV, KC_MINS,KC_PLUS,                                     KC_LBRC,KC_RBRC,KC_LCBR,KC_RCBR,KC_PIPE,KC_F12 ,
  //`-------+-------+-------+-------+-------+-------|                                    |-------+-------+-------+-------+-------+-------'
             _______,_______,KC_TILD,KC_UNDS,KC_EQL,                                     KC_LEFT,KC_DOWN,KC_UP,  KC_RIGHT,KC_BSLS,
  //        `-------+-------+-------+-------+-------+-------+-------.    ,-------+-------+-------+-------+-------+-------+-------'
                                     _______,_______,MO(3),  KC_LSFT,     KC_DEL ,_______,_______,_______
  //                                `-------+-------+-------+-------'    `-------+-------+-------+-------'
  ),
  ...
  //        `-------+-------+-------+-------+-------+-------+-------.    ,-------+-------+-------+-------+-------+-------+-------'
                                     KC_MPRV,KC_MNXT,_______,KC_MPLY,     KC_DEL ,_______,KC_ENT ,KC_BSPC
  //                                `-------+-------+-------+-------'    `-------+-------+-------+-------'
  )
};
